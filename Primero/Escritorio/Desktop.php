...
<!--<header id="Cabeza">
	<img src="Imagenes/Imagen1.png" height="21%">
</header>
...
<div id="Login">
	<form action=" "	method="POST">
		<b>Administrador: <input type="text" placeholder="Usuario" name="Usuario">
		<br><b>Password: <input type="Password" id="P" placeholder="Password" name="Password" required autofocus></br>
	</form>
</div>

<footer id="Base">
	<img src="Imagenes/Imagen2.png" height="21%">
</footer>-->
...
<body style="padding:0px; margin:0px; background-color:#fff;font-family:Arial, sans-serif">
    ...
    <div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; top:80px; left: 250px; width: 800px; height: 300px; overflow: hidden; visibility: hidden;">
        <!-- Loading Screen -->
